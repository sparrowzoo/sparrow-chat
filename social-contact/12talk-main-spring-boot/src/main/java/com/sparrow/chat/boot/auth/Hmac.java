...
public class Hmac {
    ...
    public String cryptogramHex(String algorithm, String srcString, String secretKey) {
        try {
            byte[] oauthSignature = this.cryptogram(algorithm, srcString, secretKey);
            return this.bytes2HexString(oauthSignature);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public String generateTOTP(String secretKey,
        ...
        result = this.leftPad(result, '0', codeDigits);
        return result;
    }

    public  String leftPad(String s, char c, int maxLength) {
